        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <Marquee {...settings}  direction="right">
              <div className="flex justify-between">
                <Link href="https://securitybot.gg/" target="_blank" className="w-[350px] flex flex-col items-center justify-center rounded-lg p-4 space-y-2">
                ...
                <Link href="https://erisly.com/" target="_blank" className="w-[350px] flex flex-col items-center justify-center rounded-lg p-4 space-y-2">
                ...
                <Link href="https://studiofow.com/" target="_blank" className="w-[350px] flex flex-col items-center justify-center rounded-lg p-4 space-y-2">
                ...
                <Link href="https://discords.com/" target="_blank" className="w-[350px] flex flex-col items-center justify-center rounded-lg p-4 space-y-2">
