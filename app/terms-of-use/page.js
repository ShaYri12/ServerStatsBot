...
const page = () => {
  return (
    <section className="container pt-32 text-white p-6 px-5 mx-auto">
      ...
      <p className="mb-4">
      The serverstats bot website located at serverstatsbot.com is a copyrighted work belonging to ServerStats. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
      These terms require the use of arbitration Section 10.2 on an individual basis to resolve disputes and also limit the remedies available to you in the event of a dispute. These Terms of Use were created with the help of the <a href="https://www.termsofusegenerator.net/" target="_blank"
      className="text-blue-400">Terms Of Use Generator</a>.
      </p>

      <h2 className="text-2xl font-semibold mt-6 mb-2">Access to the Site</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Third-Party Links & Ads; Other Users</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
      <b>Google DoubleClick DART Cookie.</b> Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to www.website.com and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL – <a
    ...
    >
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Copyright Policy.</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
      <b>Notice Requirement and Informal Dispute Resolution.</b> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief. A Notice to the Company should be sent to: -. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally. If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding. The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.
      </p>
      <p className="mb-4">
